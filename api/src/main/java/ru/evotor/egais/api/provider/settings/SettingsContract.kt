...
internal object SettingsContract {
    ...
    val BEER_TAPS_SETTINGS_CODES_CHECK_ENABLED_URI = Uri.withAppendedPath(BASE_URI_FROM_EGAIS_UI, BEER_TAPS_SETTINGS_CODES_CHECK_ENABLED_PATH)
    val BEER_TAPS_SETTINGS_X_API_KEY_URI = Uri.withAppendedPath(BASE_URI_FROM_EGAIS_UI, BEER_TAPS_SETTINGS_X_API_KEY_PATH)
}