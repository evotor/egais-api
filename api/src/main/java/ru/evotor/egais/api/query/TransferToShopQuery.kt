...
class TransferToShopQuery : FilterBuilder<TransferToShopQuery, TransferToShopQuery.SortOrder, TransferToShop>(TransferToShopContract.URI) {
     ...
     */
    @JvmField
    val transferDate = addFieldFilter<Date?>(TransferToShopContract.COLUMN_TRANSFER_DATE)
     ...
     */
    @JvmField
    val replyId = addFieldFilter<String?>(TransferToShopContract.COLUMN_REPLY_ID)
    ...
    class SortOrder : FilterBuilder.SortOrder<SortOrder>() {
         ...
         */
        @JvmField
        val replyId = addFieldSorter(TransferToShopContract.COLUMN_REPLY_ID)
    ...
    override fun getValue(cursor: Cursor<TransferToShop>): TransferToShop {
        ...
        val columnIndexReplyId = cursor.getColumnIndexOrThrow(TransferToShopContract.COLUMN_REPLY_ID)
